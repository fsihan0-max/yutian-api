(function initAuthModule() {
    ...
    const DEFAULT_USERS = [
        { username: "surveyor01", password: "123456", role: "surveyor", displayName: "查勘员01" },
        { username: "reviewer01", password: "123456", role: "reviewer", displayName: "复核员01" },
        { username: "admin01", password: "123456", role: "admin", displayName: "管理员01" }
    ];
    ...
    function register(payload) {
        ...
        if (!username || !password || !role) {
            return { ok: false, message: "请填写完整注册信息。" };
        }
        if (username.length < 4) {
            return { ok: false, message: "账号至少 4 位。" };
        }
